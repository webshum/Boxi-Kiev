<template>
	<div class="box checkout start-preloader">
		<div class="inner">
			<h1>Останній крок!</h1>
			<p>Залишіть ваші контакти та наш менеджер зв'яжеться з вами для уточнення деталей</p>

			<form action="/success" @submit.prevent="submitHandler">
				<label>
					<div class="label-text">ВВЕДІТЬ ІМ'Я</div>
					<div class="field">
					...
					<div class="label-text">ВВЕДІТЬ ТЕЛЕФОН</div>
					<div class="field">						
				...
				<button type="submit" class="btn"><span>Відправити заявку</span></button>
			</form>
		</div>		
	</div>
</template>
